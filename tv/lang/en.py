...
STRINGS: dict[str, str] = {
    ...
    "main.keepalive_reason_scheduled": "scheduled reconnect",
    "main.reconnect_scheduled": "Scheduled reconnect every {interval}",
    "main.reconnect_scheduled_at": "Scheduled reconnect at {time}",
    "main.reconnect_now": "Reconnecting{tunnels}...",
    ...
    "defaults.format_hint": 'Format: [tunnels.<name>] with type = "openvpn" | "fortivpn" | "openconnect" | "singbox" | "xray" | "wireguard"',
    ...
    "vpn.openconnect.exited": "Process exited with code: {rc}",
    "vpn.openconnect.log_hint": "Log: {path}",
    "vpn.openconnect.connected": "OpenConnect connected ({iface})",
    "vpn.openconnect.unsupported_windows": "openconnect is not available on Windows",
    # --- vpn/singbox.py ---
    ...
    # --- vpn/xray.py ---
    "vpn.xray.not_connected": "xray did not start within {timeout}s",
    "vpn.xray.alive_no_iface": "Process alive (PID={pid}), but interface did not appear",
    "vpn.xray.alive_no_port": "Process alive (PID={pid}), but port {port} is not listening",
    "vpn.xray.exited": "Process exited with code: {rc}",
    "vpn.xray.log_hint": "Log: {path}",
    "vpn.xray.connected": "xray connected ({iface})",
    "vpn.xray.connected_proxy": "xray proxy listening on 127.0.0.1:{port}",
    "vpn.xray.config_not_found": "Config file not found: {path}",
    "vpn.xray.late_crash": "xray process died after interface appeared (PID={pid}, rc={rc})",
    # --- vpn/sshtunnel.py ---
    ...
    "param.xray_config": "xray config",
    "param.xray_mode": "xray mode (tun/proxy)",
    "param.xray_socks_port": "xray SOCKS port",
    ...
    "cli.reconnect": "Reconnect tunnels (disconnect + connect)",
    "cli.proxy": "TUN + proxy mode: --proxy [port] (default 1080)",
    "cli.proxy_only": "Proxy-only mode (no TUN): --proxy-only [port] (default 1080)",
